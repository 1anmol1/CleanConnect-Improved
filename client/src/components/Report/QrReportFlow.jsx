...
// This path now correctly navigates up from 'components/Report' to 'src',
// then down into 'pages/Citizen/ReportIssue' to find the CSS file.
...
const QrReportFlow = ({ qrBinId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!photo) { toast.error("Please provide a photo as proof."); return; }
    setLoading(true);
        ...
        <div className="report-form-card">
          ...
          <form onSubmit={handleSubmit} className="report-form">
            ...
            <div className="form-group">
              ...
              <textarea value={formData.description} rows="4" readOnly></textarea>
            </div>
            <div className="form-group">
